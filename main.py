...
async def get_weather(area_id: str):
    """
    Fetches hourly weather data (temp, humidity, wind speed) for a given area_id.
    """
    ...
    # Fetching temperature_2m, relative_humidity_2m, wind_speed_10m
